          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/leo-1228/ppk" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p> REST API application, written in Typescript. Full CRUD server application, built on the Nestjs framework, for a social media network with users, profiles and posts. User authentication is built with Passport. The database is Postgresql with TypeORM as the ORM. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Nest.js</li> <li>TypeScript</li> <li>PostgreSql</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/leo-1228/TSP_Help" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="#"  target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>
              The objective of this application is to find an efficient route for multiple package delivery trucks, a variation of the “traveling salesman problem.” I chose to use the “nearest neighbor” algorithm as my solution to this challenge as it is able to generate a reasonably efficient route without taking an unacceptable amount of computation time. This algorithm simply iterates through a list of vertices in a graph data structure, and stores the smallest edge weight, i.e.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/leo-1228/Ecommerce_Next" target="\_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Ecommerce</h3>
              <p>
                This is an ecommerce demonstration project built with Next.js and MongoDB. A live version can be found at Pawmart.xyz.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
